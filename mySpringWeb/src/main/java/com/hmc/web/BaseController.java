...
public class BaseController {
	...
	public BaseResultInfo service(HttpServletRequest httpRequest, @PathVariable String serviceName, @RequestBody String param, @RequestParam(defaultValue = "") String eventPackage, @RequestParam(defaultValue = "") String servicePackage){
